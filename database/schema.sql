...
CREATE TABLE tasks (
    ...
    title VARCHAR(200) NOT NULL,
    description TEXT NOT NULL,
    task_type VARCHAR(100) DEFAULT 'assignment' CHECK (task_type IN ('assignment', 'project', 'quiz', 'presentation')),
...
CREATE TABLE announcements (
    ...
    announcement_type VARCHAR(100) DEFAULT 'general' CHECK (announcement_type IN ('general', 'urgent', 'program_specific', 'maintenance')),
    target_audience VARCHAR(100) DEFAULT 'all' CHECK (target_audience IN ('all', 'students', 'mentors', 'admins')),
