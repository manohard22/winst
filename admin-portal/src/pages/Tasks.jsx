    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Create and manage program tasks and assignments</p>
        </div>
        ...
        {filteredTasks.length === 0 ? (
          <div className="col-span-full text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchTerm || programFilter ? 'Try adjusting your filters' : 'Create your first task to get started'}
            </p>
          </div>
        ) : (
            ...
            <div key={task.id} className="card hover:shadow-lg transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getTypeColor(task.taskType)}`}>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{task.submissionCount || 0}</span>
                </div>
              </div>
