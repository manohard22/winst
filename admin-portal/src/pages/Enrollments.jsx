              ...
              {filteredEnrollments.length === 0 ? (
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      {searchTerm || statusFilter ? 'Try adjusting your filters' : 'Enrollments will appear here once students enroll in programs'}
                    </p>
                  </td>
                </tr>
              ) : (
                filteredEnrollments.map((enrollment) => (
                  <tr key={enrollment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{enrollment.programTitle}</div>
                      <div className="text-sm text-gray-500">{enrollment.programDuration} weeks</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
