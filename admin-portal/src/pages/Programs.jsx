...
import { Plus, Search, Edit, Eye, Users, DollarSign, Mail, Award } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage internship programs and send certificates</p>
        </div>
        <button 
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <label htmlFor="certificateProvided" className="text-sm text-gray-700">Certificate</label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, mentorshipIncluded: e.target.checked})}
                      className="mr-2"
                    />
                    <label htmlFor="mentorshipIncluded" className="text-sm text-gray-700">Mentorship</label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <label htmlFor="projectBased" className="text-sm text-gray-700">Projects</label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <label htmlFor="remoteAllowed" className="text-sm text-gray-700">Remote</label>
                  </div>
