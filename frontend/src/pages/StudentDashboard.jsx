  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        totalSpent: userApplications.reduce(
          (sum, app) => sum + (app.payment?.amount || 0),
          0
        ),
      });
    } catch (error) {
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm text-gray-600">
                            ₹{application.internship.stipend.toLocaleString()}
                            /month
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 border border-blue-200">
              ...
              <div className="space-y-3 text-sm text-blue-800">
                <div className="flex items-start space-x-2">
                  ...
                  <span>
                    Complete your profile to increase application success rate
                  </span>
                </div>
                <div className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
                  <span>
                    Apply early to popular internships for better chances
                  </span>
                </div>
                <div className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" />
