...
import { ArrowLeft, Clock, CheckCircle, AlertCircle, Upload } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Complete these tasks to progress through your internship</p>
      </div>
          ...
          <div key={task.id} className="card">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getDifficultyColor(task.difficultyLevel)}`}>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  ...
                  {task.estimatedHours && <span>Est. Time: {task.estimatedHours}h</span>}
                </div>
              </div>
              ...
              <div className="text-right">
                {task.submission ? (
                  <div className="space-y-2">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(task.submission.status)}`}>
            ...
            {task.submission?.feedback && (
              <div className="p-4 bg-yellow-50 rounded-lg">
                ...
                <p className="text-yellow-800 text-sm">{task.submission.feedback}</p>
              </div>
            )}
          </div>
        ))}
      ...
      {tasks.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">Tasks will appear here once they are assigned</p>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Submit Task: {submissionModal.title}</h2>
                <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSubmissionData({...submissionData, liveDemoUrl: e.target.value})}
                  />
                </div>
              </div>
