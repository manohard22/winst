...
const Home = () => {
  ...
  const nextSlide = () => {
    setCurrentSlide(
      (prev) => (prev + 1) % Math.ceil(featuredPrograms.length / 3)
    );
  };
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prev) =>
        (prev - 1 + Math.ceil(featuredPrograms.length / 3)) %
        Math.ceil(featuredPrograms.length / 3)
    );
  };
  ...
  const features = [
    {
      ...
      description:
        "Our internships are designed with real industry requirements, ensuring you learn skills that employers actually need in today's competitive market.",
    },
    {
      icon: Briefcase,
      title: "Hands-On Experience",
      description:
        "Work on live projects and build a portfolio that showcases your abilities. Every internship includes practical assignments that mirror real workplace scenarios.",
    },
    {
      icon: Users,
      title: "Expert Mentorship",
      description:
        "Learn directly from industry professionals who have years of experience. Get personalized guidance and career advice throughout your journey.",
    },
    {
      icon: Award,
      title: "Recognized Certification",
      description:
        "Earn certificates that are valued by top companies. Our completion certificates demonstrate your commitment to professional development.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                ...
                requirements. Join Winst's practical internship programs
                designed by industry experts.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/programs"
                  className="bg-white text-blue-600 hover:bg-blue-50 font-semibold py-4 px-8 rounded-lg transition-all duration-200 text-center shadow-lg hover:shadow-xl"
                >
                  Explore Internships
                </Link>
                <Link
                  to="/signup"
                  className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold py-4 px-8 rounded-lg transition-all duration-200 text-center"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully crafted internship programs, each
              designed to provide industry-relevant skills and practical
              experience.
            </p>
          </div>
          ...
          {!loading && featuredPrograms.length > 0 && (
            <div className="relative">
              ...
              <div className="overflow-hidden">
                ...
                >
                  {Array.from({
                    length: Math.ceil(featuredPrograms.length / 3),
                  }).map((_, slideIndex) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're committed to providing high-quality, practical learning
              experiences that prepare you for real-world challenges
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Select from our diverse range of internship programs based on
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Engage with hands-on projects, receive mentorship, and build
                real-world skills through practical assignments
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Graduate with a strong portfolio, industry connections, and the
                confidence to excel in your chosen field
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            ...
            careers through Winst's practical internship programs. Your future
            starts here.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/programs"
              className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold py-4 px-8 rounded-lg transition-all duration-200 flex items-center justify-center"
            >
              Explore Programs
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
